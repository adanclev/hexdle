    ...
    <header className="border-b-1 border-b-light-400 dark:border-dark-400 flex justify-between items-center p-4 lg:px-10">
      <div className="cursor-pointer" onClick={softReload}>
        <h1 className="font-tektur text-2xl sm:text-3xl tracking-wider">
          ...
          <span className="text-byzantine-blue-shade dark:text-byzantine-blue">xd</span>
          <span className="text-lime-green-shade dark:text-lime-green">le</span>
        </h1>
      </div>
      {openModalWith &&
        <nav className="flex flex-row gap-6 text-primary-light dark:text-primary-dark">
          <button
            className="cursor-pointer"
            onClick={() => openModalWith(<GameInstructions />)}
          >
